...
- **Q1 (engineering; resolved 2026-07-04):** Capability-tier boundaries, resolved as the tier table docs/capability-tiers.md (tier A WebGPU compute; tier B single-threaded wasm, the universal floor; tier C isolated-posture threading overlay), adopted at the Phase 0 gate per ADR-0008 Amendment 1, with detection procedure, per-tier fit-size guidance anchored to SP-CP-003, and neutral capability-language rules.
